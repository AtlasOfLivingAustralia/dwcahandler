...
class TestMergeDwcaContent:
    ...
    def test_merge_core_and_ext_records_with_id(self):
        ...
        keys_lookup: dict = dict()
        keys_lookup[MetaElementTypes.OCCURRENCE] = ['occurrenceID']
        keys_lookup[MetaElementTypes.MULTIMEDIA] = ['identifier']
    ...
    def test_merge_core_and_ext_records_with_separate_id(self):
        ...
        delta_occ_df = pd.DataFrame(data=[["3-delta", "occ3", "species3", "-40.0000", "144.0000", "Observation"],
                                          ["4-delta", "occ4", "species4", "-10.0000", "144.0000", "Observation"],
                                          ["5-delta", "occ5", "species5", "-20.0000", "145.0000", nan],
                                          ["6-delta", "occ6", "species6", "-30.0000", "146.3048", nan]],
                                    columns=["id", "occurrenceID", "scientificName", "decimalLatitude", "decimalLongitude",
                                             "basisOfRecord"])
        ...
        delta_multimedia_df = pd.DataFrame(data=[["3-delta", "https://image3.jpg", "image/jpeg", "StillImage", "RightsHolder3"],
                                                 ...
                                                 ["6-delta", "https://image6.webp", "image/webp", "StillImage", "RightsHolder6"]],
    ...
    def test_merge_core_and_ext_records_with_separate_three_keys(self):
        """
        Test for core and extension record merging (update existing and add new rows, columns)
        Occurrence, multimedia and meta xml output is merged as expected
        """
        occ_df = pd.DataFrame(data=[["1", "I1", "C1", "occ1", "species1", "-30.0000", "144.0000"],
                                    ["2", "I1", "C1", "occ2", "species2", "-28.0000", "115.0000"],
                                    ["3", "I1", "C1", "occ3", "species3", "-36.0000", "144.30848"],
                                    ["4", "I1", "C2", "occ1", "species4", "-36.0000", "144.30848"],
                                    ["5", "I1", "C2", "occ2", "species5", "-34.0000", "144.0000"]],
                              columns=["id", "institutionCode", "collectionCode", "catalogNumber",
        ...
        multimedia_df = pd.DataFrame(data=[["1", "https://image1.jpg", "image/jpeg", "StillImage"],
                                           ...
                                           ["5", "https://image5-occ2.jpg", "image/jpeg", "StillImage"]],
                                     columns=["coreid", "identifier", "format", "type"])

        dwca_ext_obj = make_dwca(core_content=occ_df, ext_mult_content=multimedia_df, use_col_idx_as_core_id=0)

        delta_occ_df = pd.DataFrame(data=[["8", "I1", "C1", "occ3", "species3", "-40.0000", "144.0000", "Observation"],
                                          ["9", "I1", "C1", "occ4", "species4", "-10.0000", "144.0000", "Observation"],
                                          ["10", "I1", "C1", "occ5", "species5", "-20.0000", "145.0000", nan],
                                          ["11", "I1", "C1", "occ6", "species6", "-30.0000", "146.3048", nan]],
        ...
        delta_multimedia_df = pd.DataFrame(data=[["8", "https://image3.jpg", "image/jpeg", "StillImage", "RightsHolder3"],
                                                 ...
                                                 ["11", "https://image6.webp", "image/webp", "StillImage", "RightsHolder6"]],
                                           columns=["coreid", "identifier", "format", "type", "rightsHolder"])
        ...
        keys_lookup: dict = dict()
        keys_lookup[MetaElementTypes.OCCURRENCE] = ["institutionCode", "collectionCode", "catalogNumber"]
        keys_lookup[MetaElementTypes.MULTIMEDIA] = ['identifier']
        ...
        expected_occ_df = pd.DataFrame(data=[["1", "I1", "C1", "occ1", "species1", "-30.0000", "144.0000", nan],
                                             ["2", "I1", "C1", "occ2", "species2", "-28.0000", "115.0000", nan],
                                             ["3", "I1", "C1", "occ3", "species3", "-40.0000", "144.0000", "Observation"],
                                             ["4", "I1", "C2", "occ1", "species4", "-36.0000", "144.30848"],
                                             ["5", "I1", "C2", "occ2", "species5", "-34.0000", "144.0000"],
                                             ["9", "I1", "C1", "occ4", "species4", "-10.0000", "144.0000", "Observation"],
                                             ["10", "I1", "C1", "occ5", "species5", "-20.0000", "145.0000", nan],
                                             ["11", "I1", "C1", "occ6", "species6", "-30.0000", "146.3048", nan]],
                                       columns=["id", "institutionCode", "collectionCode", "catalogNumber", "scientificName", "decimalLatitude", "decimalLongitude",
                                                "basisOfRecord"])
        ...
        with ZipFile(output_obj, 'r') as zf:
            ...
            with zf.open('multimedia.csv') as multimedia_file:
                ...
                pd.testing.assert_frame_equal(multimedia_df_output,
                                              expected_multimedia_df)

            zf.close()

    def test_merge_core_and_ext_records_with_separate_three_keys_ext_sync(self):
        """
        Test for core and extension record merging (update existing and add new rows, columns)
        Occurrence, multimedia and meta xml output is merged as expected
        """
    ...
    def test_merge_core_and_ext_records_with_ext_sync(self):
        """
        Test for core and extension record merging (update existing and add new rows, columns)
        Occurrence, multimedia and meta xml output is merged as expected
        """
        ...
        DwcaHandler.merge_dwca(dwca_file=dwca_ext_obj, delta_dwca_file=delta_dwca_ext_obj,
                               output_dwca=output_obj,
                               keys_lookup=keys_lookup, extension_sync=True)
